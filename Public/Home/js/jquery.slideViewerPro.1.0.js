...
jQuery(function(){
   jQuery("div.svwp").prepend("<img src='/myblogs/public/home/images/svwloader.gif' class='ldrgif' alt='loading...'/ >"); //change with YOUR loader image path
});
var j = 0;
jQuery.fn.slideViewerPro = function(settings) {
	  settings = jQuery.extend({
			...
			leftButtonInner: "<img src='/myblogs/public/home/images/larw.gif' alt='left' />", //could be an image "<img src='images/larw.gif' />" or an escaped char as "&larr";
			rightButtonInner: "<img src='/myblogs/public/home/images/rarw.gif' alt='right' />", //could be an image or an escaped char as "&rarr";
			autoslide: false,
			typo: false,
			typoFullOpacity: 0.9,
			shuffle: false
